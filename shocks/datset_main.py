...
if __name__ == "__main__":
    ...
    with open("../data/featurized/levy_features__KO__2020-11-02_2021-04-30__30s__2_std.pkl", "rb",) as file:
        d = pickle.load(file)
    ...
    with open("../data/featurized/features__KO__2020-11-02_2021-04-30__30s__2_std.pkl", "wb",) as file:
        pickle.dump(f, file)
